...
import { BsFillBookmarkHeartFill, BsFillBarChartFill } from "react-icons/bs";
import Dashboard from './DashboardShows';
import Shows from '../Shows/AllShows';
import Subscriptions from '../Subscriptions/AllSubscriptions';


function ShowsUserPage(props) {
    return (
...
export default withRouter(ShowsUserPage);